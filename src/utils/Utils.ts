...
export class FileTreeUtils {
	...
	static getFilesUnderPath = (path: string, plugin: FileTreeAlternativePlugin, getAllFiles?: boolean): TFile[] => {
	...
	static createFolderTree = (startFolder: TFolder): FolderTree => {
	...
	static getFolderNoteCountMap = (plugin: FileTreeAlternativePlugin) => {
